...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "06a16129-3fdb-4144-8789-d952ee16dab5");
                            ...
                            <g>
                                <g>
                                    ...
                                    <motion.path
                                        ...
                                        animate={isInView && { pathLength: 1 }}
                                        transition={{ duration: 3 }}
                                        d="M376.224,282.849c-9.804-9.805-25.757-9.804-35.562,0l-18.748,18.748L216.387,196.07l18.749-18.748
